...
const NODES: NodeDef[] = [
  ...
  },
  {
    ...
    source: "fund-event-extractor.ts (RSS) + Enrichment (PitchBook, Preqin, SEC Filings, BaFin)",
...
const EDGES: EdgeDef[] = [
  ...
  {
    id: "investor_manages_fund",
    label: "MANAGES",
    category: "org_structure",
    from: "investorOrg",
    to: "fund",
    description: "Investmentfirma verwaltet diesen Fonds (Shortcut wenn kein separater FundManager bekannt)",
    cardinality: "1:N",
  },
  {
    id: "gp_of",
  ...
  {
    id: "fund_sourced_from",
    label: "SOURCED_FROM",
    category: "provenance",
    from: "fund",
    to: "article",
    description: "Fund-Closing-Information wurde aus diesem Artikel extrahiert",
    properties: [
      { name: "confidence", type: "number", description: "Extraktions-Konfidenz 0.0–1.0" },
    ],
    cardinality: "N:M",
